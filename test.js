...
test('dragging out a smaller time range', async (t) => {
  ...
  await t.test('the wheel zooms about the pointer', () => {
    ...
    // Pointer at 30% across the plot, one notch up: the span narrows, and the instant
    ...
    // Wheel down from inside a zoom widens it; past the loaded range it is no zoom at all.
